...
const questions = [
  {
    text: "일을 맡으면 저는 대충 끝내기보다 제대로 해내야 마음이 놓여요.",
  ...
  {
    text: "누군가 힘들어 보이면 제 일이 아니어도 도와주고 싶어져요.",
  ...
  {
    text: "저는 목표가 생기면 꽤 빠르게 몰입하고 결과를 내고 싶어져요.",
    mood: "앞으로 나아가는 에너지 🚀",
    answers: [
  ...
  {
    text: "저는 기분, 분위기, 감정의 결을 다른 사람보다 깊게 느끼는 편이에요.",
    mood: "감정을 들여다보는 시간 🌙",
    answers: [
  ...
  {
    text: "새로운 주제를 알게 되면 혼자 깊게 파고들고 정리하는 게 즐거워요.",
    mood: "머릿속이 반짝이는 시간 📚",
    answers: [
  ...
  {
    text: "무언가를 시작하기 전, 혹시 모를 위험이나 실수를 먼저 생각하는 편이에요.",
    mood: "안전을 살펴보는 시간 🛡️",
    answers: [
  ...
  {
    text: "재미있고 설레는 일이 보이면 우선 해보고 싶어지는 편이에요.",
    mood: "통통 튀는 기분 🍋",
    answers: [
  ...
  {
    text: "답답한 상황에서는 누가 뭐라 해도 제가 앞에 나서서 정리하는 편이에요.",
    mood: "주도권이 드러나는 시간 🔥",
    answers: [
  ...
  {
    text: "저는 갈등이 생기면 강하게 부딪히기보다 조용히 넘어가고 싶을 때가 많아요.",
    mood: "부드러운 균형의 시간 ☁️",
    answers: [
  ...
  {
    text: "스스로에게 '이 정도로는 부족해'라고 말하는 순간이 자주 있어요.",
    mood: "내면의 기준을 보는 시간 🎯",
    answers: [
      { text: "정말 그렇다", scores: {1: 3, 3: 1} },
  ...
  {
    text: "사람들에게 사랑받고 필요 있는 존재가 되고 싶다는 마음이 커요.",
  ...
  {
    text: "저는 인정받을 때 더 힘이 나고, 성과가 분명하면 더 신나요.",
    mood: "빛나는 성취의 시간 🏆",
    answers: [
  ...
  {
    text: "평범한 것보다 나다운 것, 진짜 내 마음에 맞는 것이 중요해요.",
    mood: "나만의 색을 만나는 시간 🎨",
    answers: [
      { text: "정말 그렇다", scores: {4: 3} },
  ...
  {
    text: "사람들과 오래 함께 있으면 혼자만의 시간이 꼭 필요해져요.",
    mood: "고요한 충전의 시간 🌌",
    answers: [
      { text: "정말 그렇다", scores: {5: 3} },
  ...
  {
    text: "결정하기 전에 여러 가능성과 변수들을 오래 점검하는 편이에요.",
    mood: "조심스럽게 살피는 시간 🧭",
    answers: [
  ...
  {
    text: "답답하거나 우울한 감정이 오래 이어지면 다른 즐거운 일을 찾아 움직이고 싶어요.",
    mood: "가볍게 튀어오르는 시간 🎈",
    answers: [
  ...
  {
    text: "저는 약한 모습으로 보이기보다 강한 쪽에 서고 싶다는 마음이 있어요.",
    mood: "단단한 힘을 보는 시간 🦁",
    answers: [
  ...
  {
    text: "누군가와 다투는 것보다 그냥 참고 분위기를 지키는 쪽을 택할 때가 많아요.",
    mood: "평온함을 지키는 시간 🍃",
    answers: [
