...
const questions = [
  ...
  {
    text: "무언가를 시작하기 전, 혹시 모를 \n위험이나 실수를 먼저 생각하는 편이다.",
    mood: "안전을 살펴보는 시간",
    answers: [
  ...
  {
    text: "사람들에게 사랑받고 필요 있는 존재가 되고 싶다는 마음이 있다.",
  ...
  {
    text: "결정하기 전에 여러 가능성과 변수들을 오래 점검하는 편이다.",
    mood: "조심스럽게 살피는 시간",
    answers: [
  ...
  {
    text: "누군가와 다투는 것보다 그냥 참고\n 분위기를 지키는 쪽을 택할 때가 많다.",
    mood: "평온함을 지키는 시간",
    answers: [
